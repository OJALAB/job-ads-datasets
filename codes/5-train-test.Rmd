...
all_sources <- all_sources[class %in% hierachy6$class] ## 8 wrong
...
fwrite(x = test_data[, .(class, desc, source)], file = "../data/train-test/test-data-2024.csv", quote = T, encoding = "UTF-8")
fwrite(x = train_data[, .(class, desc, source)], file = "../data/train-test/train-data-2024.csv", quote = T, encoding = "UTF-8")
