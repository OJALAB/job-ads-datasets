...
fwrite(x = train_data[1:300000, .(class, desc=desc, source)], file = "../data/train-test/train-data-whole-2024-1.tar.gz")
fwrite(x = train_data[300001:nrow(train_data), .(class, desc=desc, source)], file = "../data/train-test/train-data-whole-2024-2.tar.gz")
...
fwrite(x = train_data[1:300000, .(class, desc=desc, source)], file = "../data/train-test/train-data-whole-source-2024-1.tar.gz")
fwrite(x = train_data[300001:nrow(train_data), .(class, desc=desc, source)], file = "../data/train-test/train-data-whole-source-2024-2.tar.gz")
