...
df_full <- rbind(
  fread("~/mac/nauka/oja-lab/job-ads-datasets/data/train-test/train-data-2024.tar.gz", colClasses = "character"),
  fread("~/mac/nauka/oja-lab/job-ads-datasets/data/train-test/test-data-2024.tar.gz", colClasses = "character")
)
```
